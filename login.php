...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url(https://images.pexels.com/photos/6433/painting-pencil-paint-pencils.jpg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260);">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <h5>Don't have an account? <a href="index.php">Sign up now</a></h5>
            </div>
        </div>
    </div>
